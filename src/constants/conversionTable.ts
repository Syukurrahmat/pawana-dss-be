...
export const ISPUConvertionTable = [
    {
        ...
        recomendation: {
            ...
            company: 'Operasional pabrik tahu dapat berjalan normal tanpa ada penyesuaian khusus. Aktivitas luar ruangan seperti pemindahan bahan baku atau produk jadi dapat dilakukan tanpa masalah.',
    ...
    },
    {
        ...
        recomendation: {
            ...
            company: 'Pabrik perlu memantau kesehatan pekerja yang sensitif terhadap kualitas udara dan menyediakan fasilitas medis. Mereka juga bisa menyesuaikan jadwal kerja untuk mengurangi paparan udara luar bagi pekerja yang sensitif.',
    ...
    },
    {
        ...
        recomendation: {
            ...
            company: 'Pabrik harus mengurangi aktivitas luar ruangan dan memberikan perlindungan tambahan bagi pekerja dengan kondisi kesehatan tertentu. Mereka juga perlu meningkatkan filtrasi udara di dalam ruangan dan menyediakan area istirahat yang bersih dan sehat.',
    ...
    },
    {
        ...
        recomendation: {
            ...
            company: 'Pabrik harus menunda atau memindahkan aktivitas luar ruangan ke dalam ruangan sebanyak mungkin. Mereka juga harus memastikan sistem ventilasi dalam ruangan berfungsi dengan baik dan memberikan pelindung pernapasan seperti masker kepada pekerja jika diperlukan.',
...
export const CO2ConversionTable = [
    {
        ...
        recomendation: {
            ...
            company: "Tetap melakukan pemantauan rutin terhadap kualitas udara untuk memastikan kadar CO2 tetap stabil dan rendah. Memastikan sistem ventilasi yang memadai agar udara bersirkulasi dengan baik dapat menghindari penumpukan CO2 di area kerja dan menjaga kadar oksigen yang cukup.",
    ...
    },
    {
        ...
        recomendation: {
            ...
            company: 'Disarankan untuk memasang sistem filtrasi udara yang efektif dan pemantauan kualitas udara untuk memastikan kadar CO2 tetap dalam batas aman. Penggunaan sumber energi terbarukan seperti panel surya juga bisa menjadi solusi untuk mengurangi emisi CO2 dari proses produksi.',
