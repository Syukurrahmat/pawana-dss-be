...
export class DashboardService extends DashboardLogic {
    ...
    async forCompany(company: Companies, tz: string) {
        ...
        const result: DashboardData = {
            ...
            nodes: {
                indoor: indoorNodesWLastestData.map((e) => ({
                    ...e.toJSON(),
                    latestData: e.latestData,
                })) as any,
                outdoor: outdoorNodesWLastestData.map((e) => ({
                    ...e.toJSON(),
                    latestData: e.latestData,
                })) as any,
            },
    ...
    async forRegularUser(user: Users, tz: string) {
        const outdoorNodes = await user.getSubscribedNodes({
            attributes: this.nodeAttributes,
            joinTableAttributes: [],
        });
        ...
        const filteredAnalyzedOutdoorNodes = analyzedOutdoorNodes.filter(
            (e) => e.latestData
        ) as NodeWithLatestData[];
        ...
        const result: DashboardData = {
            ...
            nodes: {
                indoor: undefined,
                outdoor: analyzedOutdoorNodes.map((e) => ({
                    ...e.toJSON(),
                    latestData: e.latestData,
                })) as any,
            },
