import { createNewCompany, editCompanyProfile, getAllCompanies, getCompanyById, getAllSubscribedNode, getCompaniesSummary, deleteNodeSubscription, addNodeSubscription, getAllPrivateNode, getRemainingSubsLimit } from '../../../_controller/companies.controler.js';
import { Router } from 'express';
import db from '../../../_models/index.js';
import eventLogsRouter from './eventLogs.js';
import { dashboardDataForCompany } from '../../../_controller/dashboard.controller.js';
