...
import './_auth/localStrategy.js';
import { isAuthenticated, userSessionData } from './_middleware/index.middleware.js';
import db from './_models/index.js';
import apiRouter from './_routers/api/index.js';
import authRouter from './_routers/auth/index.js';
